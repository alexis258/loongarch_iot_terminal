...
void basechart::temperature_chartInit()
{
    ...
    temperature_axisX->setTickCount(3+1);            //设置坐标轴区间格数
...
void basechart::humidity_chartInit()
{
    ...
    humidity_axisX->setTickCount(3+1);            //设置坐标轴区间格数
...
void basechart::lightlux_chartInit()
{
    ...
    lightlux_axisY->setRange(0, 6000);

    lightlux_axisX->setGridLineVisible(true);    //是否显示网格
    lightlux_axisY->setGridLineVisible(true);

    lightlux_axisX->setTickCount(3+1);            //设置坐标轴区间格数
    lightlux_axisY->setTickCount(6+1);
